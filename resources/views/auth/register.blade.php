                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="text" class="form-control " name="cedula" value="{{ old('name') }}" required autocomplete="name" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apellido" type="text" class="form-control" name="apellido" value="{{ old('name') }}" required autocomplete="name" autofocus>
                            </div>
                        </div>
